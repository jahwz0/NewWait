    ...
    return(
        <div className="bg-[#FF2600] p-8 sm:p-16 md:p-[50px] lg:p-[100px] border-2 border-black flex flex-col xl:flex-row items-start xl:items-center gap-6">
            <div className="text-white flex-1">
                <p className="text-[40px] sm:text-[64px] md:text-[96px] font-soulcraft leading-[84%] tracking-[-2px] sm:tracking-[-4px]">MORE QUESTIONS?</p>
            ...
            <div className="shrink-0">
                ...
                <span className="text-white border-3 py-2 px-4 rounded-full text-[14px] sm:text-[18px] md:text-[24px] leading-[145%]">Team@BLKBAR.com</span>
            </div>
        </div>
    )
}
